	...
	<body>
		...
		<div id="show-professor" class="content scaffold-show" role="main">
			...
			<ol class="property-list professor">
				...
				<g:if test="${professorInstance?.nomeProfessor}">
				<li class="fieldcontain">
					<span id="nomeProfessor-label" class="property-label"><g:message code="professor.nomeProfessor.label" default="Nome Professor" /></span>
					
						<span class="property-value" aria-labelledby="nomeProfessor-label"><g:fieldValue bean="${professorInstance}" field="nomeProfessor"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${professorInstance?.sexo}">
				<li class="fieldcontain">
					<span id="sexo-label" class="property-label"><g:message code="professor.sexo.label" default="Sexo" /></span>
					
						<span class="property-value" aria-labelledby="sexo-label"><g:fieldValue bean="${professorInstance}" field="sexo"/></span>
